...
| `POOL-ECON-003` | `DONE` | Scene Jobs & persönliches Bargeld | fünf serverautorisierte Jobs, Finance-Ledger, A4-Jobkarten; 0.8.8-B / PR #105 |
...
|---|---|---|---|---|
| `POOL-COMPANION-001` | `PULLED` | **Secret Best Friend Assistant** | genau einen vorhandenen Scene Job nach jeder bestätigten Straßenrunde automatisch mitziehen | nutzt ausschließlich `SceneJobService`; eine aktive Aufgabe; Stop/Wechsel; keine Systemzeit und keine Client-Effekte |
...
| `POOL-ECON-004` | `READY` | **Job-Erschöpfung / Anti-Grind** | verhindert bedeutungsloses Endlosfarmen bei extrem niedriger Energie | Grundregel „phasenunabhängig arbeitbar“ erhalten; Balance erst auf validierter B-Baseline ändern |
...
`POOL-COMPANION-001` ist aktiv und verwendet die sicher gemergte B-Jobbasis. Nach seinem Remote-PASS folgt `POOL-FINANCE-001`; Bank und Anlagen bauen auf demselben persönlichen Finance-Ledger auf.
