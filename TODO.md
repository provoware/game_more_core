...
- **Start-/Release-Qualität:** Arbeit, Einkommen und vorhandener Equipment-Handel sind im Control Deck verständlicher, vollständig bedienbar und visuell klarer; Preise und Bestände bleiben Runtime-Autorität
...
- [x] Jobkarten zeigen Stundenlohn, tatsächliche Erschöpfungs-Lohnvorschau sowie Energie-/Stresskosten verständlich zusammen
- [x] vorhandener Equipment-Handel ist vollständig bedienbar: Kaufen, Verkaufen, Reservieren und Freigeben; Marktpreis und Bestand bleiben Runtime-Autorität
- [x] Geldkreislauf und responsive visuelle Hierarchie führen von Arbeit → Bargeld → Bank → Handel → spätere Investition
- [x] neue Laienhilfe `docs/ARBEIT_GELD_HANDEL_LAIENHILFE.md`; keine zweite Economy- oder Marktengine
