...
from bunkerfrequenz.application.assistant_control_service import replay_assistant_control_event
...
from bunkerfrequenz.application.personal_finance_service import replay_personal_finance_event
...
def replay_game_event(derived_state: dict, record: dict) -> dict:
    ...
    state = replay_personal_finance_event(state, record)
